        ...
        <div className="exercise-list">
                    {
                        ...
                        <div className="exercise-box">
                                <div className="exercise-hover"
                                    ...
                                    data-img={ item.img}
                                    onClick={addList}>
                                    <BiAddToQueue data-id={item.id} data-name={ item.name } data-img={ item.img}/>
                            </div>
                    ...
                    <div className="exercise-box">
                    <div className="exercise-hover" data-id="1" data-name="Squat" data-img="" onClick={ addList}>
                            <BiAddToQueue data-id="1" data-name="Squat" data-img=""/>
                        </div>
                        <div className="exercise-img">
                    ...
                    <div className="exercise-box">
                        <div className="exercise-hover" data-id="2" data-name="Stretch" data-img="" onClick={ addList}>
                            <BiAddToQueue data-id="2" data-name="Stretch" data-img=""/>
                        </div>
                        <div className="exercise-img">
                            <img src={Stretch}></img>
                        </div>
