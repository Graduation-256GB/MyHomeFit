...
class PoseWebCam(object):
    def __init__(self):
        ...
        self.userExerciseList={'STANDING SIDE CRUNCH': 7, 'STEP FORWARD DYNAMIC LUNGE': 5, "BURPEE TEST":6}
    ...
    def get_frame(self):
        ...
        if results.pose_landmarks:
            ...
            # if userexercisecnt==userexerciseframecnt:
            #     self.userexercisename=keylist[1]    
